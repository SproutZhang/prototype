...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function wa(e,t,n){let r=new Float32Array(ua),i=new q(0,1,0);return new ai({name:`SphericalGaussianBlur`,defines:{n:ua,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Da(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ta(){return new ai({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Da(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ea(){return new ai({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Da(),fragmentShader:`
...
`;function _c({color:e=`#fc42ff`,colorTwo:t=`#42fcff`,speed:n=1,ringCount:i=6,attenuation:a=10,lineThickness:o=2,baseRadius:s=.35,radiusStep:c=.1,scaleRate:l=.1,opacity:u=1,blur:d=0,noiseAmount:f=.1,rotation:p=0,ringGap:m=1.5,fadeIn:h=.7,fadeOut:g=.5,followMouse:_=!1,mouseInfluence:v=.2,hoverScale:y=1.2,parallax:b=.05,clickBurst:x=!1}){let S=(0,r.useRef)(null),C=(0,r.useRef)(null),w=(0,r.useRef)([0,0]),T=(0,r.useRef)([0,0]),E=(0,r.useRef)(0),D=(0,r.useRef)(!1),O=(0,r.useRef)(0);return C.current={color:e,colorTwo:t,speed:n,ringCount:i,attenuation:a,lineThickness:o,baseRadius:s,radiusStep:c,scaleRate:l,opacity:u,noiseAmount:f,rotation:p,ringGap:m,fadeIn:h,fadeOut:g,followMouse:_,mouseInfluence:v,hoverScale:y,parallax:b,clickBurst:x},(0,r.useEffect)(()=>{let e=S.current;if(!e)return;let t;try{t=new pc({alpha:!0})}catch{return}if(!t.capabilities.isWebGL2){t.dispose();return}t.setClearColor(0,0),e.appendChild(t.domElement);let n=new gn,r=new Ni(-.5,.5,.5,-.5,.1,10);r.position.z=1;let i={uTime:{value:0},uAttenuation:{value:0},uResolution:{value:new K},uColor:{value:new X},uColorTwo:{value:new X},uLineThickness:{value:0},uBaseRadius:{value:0},uRadiusStep:{value:0},uScaleRate:{value:0},uRingCount:{value:0},uOpacity:{value:1},uNoiseAmount:{value:0},uRotation:{value:0},uRingGap:{value:1.6},uFadeIn:{value:.5},uFadeOut:{value:.75},uMouse:{value:new K},uMouseInfluence:{value:0},uHoverAmount:{value:0},uHoverScale:{value:1},uParallax:{value:0},uBurst:{value:0}},a=new ai({vertexShader:hc,fragmentShader:gc,uniforms:i,transparent:!0,glslVersion:We}),o=new Nr(new Xr(1,1),a);n.add(o);let s=!1,c=t.domElement,l=()=>{if(s)return;let n=e.clientWidth,r=e.clientHeight;if(n<=0||r<=0)return;let a=Math.min(window.devicePixelRatio,2);t.setSize(n,r),t.setPixelRatio(a),i.uResolution.value.set(n*a,r*a)};l(),window.addEventListener(`resize`,l);let u=new ResizeObserver(l);u.observe(e);let d=t=>{let n=e.getBoundingClientRect();w.current[0]=(t.clientX-n.left)/n.width-.5,w.current[1]=-((t.clientY-n.top)/n.height-.5)},f=()=>{D.current=!0},p=()=>{D.current=!1,w.current[0]=0,w.current[1]=0},m=()=>{O.current=1};e.addEventListener(`mousemove`,d),e.addEventListener(`mouseenter`,f),e.addEventListener(`mouseleave`,p),e.addEventListener(`click`,m);let h=0,g=e=>{h=requestAnimationFrame(g);let a=C.current;a&&(T.current[0]+=(w.current[0]-T.current[0])*.08,T.current[1]+=(w.current[1]-T.current[1])*.08,E.current+=(+!!D.current-E.current)*.08,O.current*=.95,O.current<.001&&(O.current=0),i.uTime.value=e*.001*a.speed,i.uAttenuation.value=a.attenuation,i.uColor.value.set(a.color),i.uColorTwo.value.set(a.colorTwo),i.uLineThickness.value=a.lineThickness,i.uBaseRadius.value=a.baseRadius,i.uRadiusStep.value=a.radiusStep,i.uScaleRate.value=a.scaleRate,i.uRingCount.value=a.ringCount,i.uOpacity.value=a.opacity,i.uNoiseAmount.value=a.noiseAmount,i.uRotation.value=a.rotation*Math.PI/180,i.uRingGap.value=a.ringGap,i.uFadeIn.value=a.fadeIn,i.uFadeOut.value=a.fadeOut,i.uMouse.value.set(T.current[0],T.current[1]),i.uMouseInfluence.value=a.followMouse?a.mouseInfluence:0,i.uHoverAmount.value=E.current,i.uHoverScale.value=a.hoverScale,i.uParallax.value=a.parallax,i.uBurst.value=a.clickBurst?O.current:0,t.render(n,r))};return h=requestAnimationFrame(g),()=>{s=!0,cancelAnimationFrame(h),window.removeEventListener(`resize`,l),u.disconnect(),e.removeEventListener(`mousemove`,d),e.removeEventListener(`mouseenter`,f),e.removeEventListener(`mouseleave`,p),e.removeEventListener(`click`,m),c.parentNode===e&&e.removeChild(c),o.geometry.dispose(),a.dispose(),t.dispose()}},[]),(0,mc.jsx)(`div`,{ref:S,className:`magic-rings-container`,style:d>0?{filter:`blur(${d}px)`}:void 0})}export{_c as default};